...
g20 = m20[['de_dt','buy_ct']].groupby('de_dt').sum().sort_values('buy_ct', ascending=False)
g30 = m30[['de_dt','buy_ct']].groupby('de_dt').sum().sort_values('buy_ct', ascending=False)
g40 = m40[['de_dt','buy_ct']].groupby('de_dt').sum().sort_values('buy_ct', ascending=False)
g50 = m50[['de_dt','buy_ct']].groupby('de_dt').sum().sort_values('buy_ct', ascending=False)
g60 = m60[['de_dt','buy_ct']].groupby('de_dt').sum().sort_values('buy_ct', ascending=False)
g70 = m70[['de_dt','buy_ct']].groupby('de_dt').sum().sort_values('buy_ct', ascending=False)
df = pd.concat([g20,g30,g40,g50,g60,g70],axis=1)
df.columns = ['20대','30대','40대','50대','60대','70대']
df.to_pickle('../data/age_man_purchase.pickle')
