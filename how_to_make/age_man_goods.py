...
g20 = m20[['pd_nm','buy_ct']].groupby('pd_nm').sum().sort_values('buy_ct', ascending=False)
g30 = m30[['pd_nm','buy_ct']].groupby('pd_nm').sum().sort_values('buy_ct', ascending=False)
g40 = m40[['pd_nm','buy_ct']].groupby('pd_nm').sum().sort_values('buy_ct', ascending=False)
g50 = m50[['pd_nm','buy_ct']].groupby('pd_nm').sum().sort_values('buy_ct', ascending=False)
g60 = m60[['pd_nm','buy_ct']].groupby('pd_nm').sum().sort_values('buy_ct', ascending=False)
g70 = m70[['pd_nm','buy_ct']].groupby('pd_nm').sum().sort_values('buy_ct', ascending=False)
df = pd.concat([g20,g30,g40,g50,g60,g70],axis=1)
df.columns = ['20대','30대','40대','50대','60대','70대']
df.to_pickle('../data/age_man_goods.pickle')