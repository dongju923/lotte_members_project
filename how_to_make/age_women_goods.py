...
g20 = w20[['pd_nm','buy_ct']].groupby('pd_nm').sum().sort_values('buy_ct', ascending=False)
g30 = w30[['pd_nm','buy_ct']].groupby('pd_nm').sum().sort_values('buy_ct', ascending=False)
g40 = w40[['pd_nm','buy_ct']].groupby('pd_nm').sum().sort_values('buy_ct', ascending=False)
g50 = w50[['pd_nm','buy_ct']].groupby('pd_nm').sum().sort_values('buy_ct', ascending=False)
g60 = w60[['pd_nm','buy_ct']].groupby('pd_nm').sum().sort_values('buy_ct', ascending=False)
g70 = w70[['pd_nm','buy_ct']].groupby('pd_nm').sum().sort_values('buy_ct', ascending=False)
df = pd.concat([g20,g30,g40,g50,g60,g70],axis=1)
df.columns = ['20대','30대','40대','50대','60대','70대']
df.to_pickle('../data/age_women_goods.pickle')